...
const projects = [
  { 
    title: 'AutoTech', 
    category: 'Automotriz', 
    url: 'auto-tech-three.vercel.app', 
    github: 'https://github.com/sanchezedu/auto-tech',
    img: 'https://images.unsplash.com/photo-1487754180451-c456f719a1fc?w=600' 
  },
  { 
    title: 'Delizia', 
    category: 'Restaurante', 
    url: 'delizia-restaurant.vercel.app', 
    github: 'https://github.com/sanchezedu/delizia-restaurant',
    img: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=600' 
  },
  { 
    title: 'Aurora Cove', 
    category: 'Hotel', 
    url: 'aurora-cove.vercel.app', 
    github: 'https://github.com/sanchezedu/aurora-cove',
    img: 'https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=600' 
  },
  { 
    title: 'VisionOptica', 
    category: 'Óptica', 
    url: 'vision-optica-premium.vercel.app', 
    github: 'https://github.com/sanchezedu/vision-optica-premium',
    img: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=600' 
  },
  { 
    title: 'Paws Clinic', 
    category: 'Veterinaria', 
    url: 'paws-clinic-chi.vercel.app', 
    github: 'https://github.com/sanchezedu/paws-clinic',
    img: 'https://images.unsplash.com/photo-1548199973-03cce0bbc87b?w=600' 
  },
  { 
    title: 'LexCorp', 
    category: 'Abogados', 
    url: 'lexcorp-firma.vercel.app', 
    github: 'https://github.com/sanchezedu/lexcorp-firma',
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] font-sans overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div 
          className="absolute w-[600px] h-[600px] rounded-full opacity-30 transition-all duration-1000 ease-out"
          style={{
        ...
        <div className="absolute top-0 left-0 w-full h-full opacity-20">
          ...
          <div className="absolute top-1/2 left-1/2 w-64 h-64 bg-gradient-to-r from-pink-500 to-rose-600 rounded-full blur-[80px] animate-pulse" style={{ animationDelay: '2s' }}></div>
        </div>
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 backdrop-blur-md ${scrolled ? 'bg-[#0a0a0a]/90' : 'bg-transparent'}`}>
        <div className="max-w-6xl mx-auto px-8 h-20 flex items-center justify-between">
          <div className="text-2xl font-bold tracking-tight">
            ...
            <span className="bg-gradient-to-r from-violet-400 via-cyan-400 to-pink-400 bg-clip-text text-transparent">.dev</span>
          </div>
          <nav className="hidden md:flex items-center gap-8">
            <a href="#proyectos" className="text-gray-300 hover:text-white transition font-medium text-sm">Proyectos</a>
            <a href="#testimonios" className="text-gray-300 hover:text-white transition font-medium text-sm">Testimonios</a>
            <a href="#servicios" className="text-gray-300 hover:text-white transition font-medium text-sm">Servicios</a>
            <a href="#contacto" className="bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 text-white px-6 py-2.5 rounded-full text-sm font-medium transition transform hover:scale-105">
              Contactar
            </a>
          </nav>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <div className="inline-flex items-center gap-3 px-5 py-2.5 bg-white/5 border border-white/10 rounded-full">
                ...
                <span className="text-gray-200 text-sm font-medium">Disponible para proyectos</span>
              </div>
              ...
              <div className="flex gap-4">
                <a href="https://github.com/sanchezedu" className="w-11 h-11 bg-white/5 hover:bg-white/10 border border-white/10 rounded-full flex items-center justify-center text-gray-300 hover:text-white transition">
                ...
                <a href="https://linkedin.com/in/eduardo-sanchez" className="w-11 h-11 bg-white/5 hover:bg-white/10 border border-white/10 rounded-full flex items-center justify-center text-gray-300 hover:text-white transition">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                </a>
                <a href="mailto:edu@local.dev" className="w-11 h-11 bg-white/5 hover:bg-white/10 border border-white/10 rounded-full flex items-center justify-center text-gray-300 hover:text-white transition">
              ...
              <div className="flex gap-10 pt-4">
                <div className="text-center">
                  ...
                  <div className="text-gray-400 text-sm mt-1">Proyectos</div>
                </div>
                <div className="text-center">
                ...
                <div className="text-center">
                  ...
                  <div className="text-gray-400 text-sm mt-1">Años Exp.</div>
                </div>
              </div>
            </div>
            ...
            <div className="hidden md:flex justify-center">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-violet-600/30 to-pink-600/30 rounded-full blur-[80px]"></div>
                <div className="relative bg-gradient-to-br from-[#1a1a2e] to-[#0a0a0a] border border-white/10 rounded-3xl p-8 shadow-2xl">
                  <div className="w-40 h-40 mx-auto mb-6 rounded-full overflow-hidden border-4 border-white/20">
                    <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop&crop=face" alt="Edu" className="w-full h-full object-cover" />
                  </div>
                  <div className="text-2xl font-bold text-center text-white mb-2">Edu.dev</div>
                  <div className="text-center">
                    <span className="bg-gradient-to-r from-violet-400 to-pink-400 bg-clip-text text-transparent font-medium">Full Stack Developer</span>
                  </div>
                  <div className="mt-6 flex justify-center gap-2 flex-wrap">
                    <span className="px-3 py-1.5 bg-white/5 border border-white/10 rounded-full text-xs text-gray-300">React</span>
                    <span className="px-3 py-1.5 bg-white/5 border border-white/10 rounded-full text-xs text-gray-300">Next.js</span>
                    <span className="px-3 py-1.5 bg-white/5 border border-white/10 rounded-full text-xs text-gray-300">GSAP</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-12 bg-white/5 border-y border-white/5">
        <div className="max-w-6xl mx-auto px-8">
          <p className="text-center text-gray-400 text-sm uppercase tracking-widest mb-6">Tecnologías</p>
      ...
      <section id="testimonios" className="py-24 relative">
        <div className="max-w-6xl mx-auto px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400">Testimonios de proyectos realizados</p>
          </div>
      ...
      <section id="servicios" className="py-24 bg-white/5">
        <div className="max-w-6xl mx-auto px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400">Lo que puedo ofrecerte</p>
          </div>
      ...
      <section id="proyectos" className="py-24 relative">
        <div className="max-w-6xl mx-auto px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400">Landing pages profesionales</p>
          </div>
            ...
            {projects.map((project, i) => (
              <div key={i} className="group block bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:bg-white/10 hover:border-cyan-500/30 transition duration-300">
                ...
                <div className="p-5">
                  ...
                  <p className="text-gray-500 text-sm mt-1 mb-4">{project.url}</p>
      ...
      <section id="contacto" className="py-24 relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-8 text-center relative z-10">
          ...
          <p className="text-xl text-gray-300 mb-10">Contáctame y hagamos tu proyecto realidad</p>
          ...
          <div className="grid md:grid-cols-3 gap-12 text-center md:text-left">
            <div>
              <div className="text-2xl font-bold mb-4">
                <span className="text-white">Edu</span>
                <span className="bg-gradient-to-r from-violet-400 to-pink-400 bg-clip-text text-transparent">.dev</span>
              </div>
              <p className="text-gray-400">Desarrollo Web y Soluciones Digitales</p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#proyectos" className="text-gray-400 hover:text-violet-400 transition">Proyectos</a></li>
                <li><a href="#testimonios" className="text-gray-400 hover:text-violet-400 transition">Testimonios</a></li>
                <li><a href="#servicios" className="text-gray-400 hover:text-violet-400 transition">Servicios</a></li>
                <li><a href="#contacto" className="text-gray-400 hover:text-violet-400 transition">Contacto</a></li>
              </ul>
            </div>
          </div>
