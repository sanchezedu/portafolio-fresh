...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] font-sans overflow-x-hidden">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <div className="flex gap-4">
                <a href="https://github.com/sanchezedu" className="w-11 h-11 bg-white/5 hover:bg-white/10 border border-white/10 rounded-full flex items-center justify-center text-gray-400 hover:text-white transition">
                ...
                <a href="https://linkedin.com/in/eduardo-sanchez" className="w-11 h-11 bg-white/5 hover:bg-white/10 border border-white/10 rounded-full flex items-center justify-center text-gray-400 hover:text-white transition">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                </a>
                <a href="mailto:edu@local.dev" className="w-11 h-11 bg-white/5 hover:bg-white/10 border border-white/10 rounded-full flex items-center justify-center text-gray-400 hover:text-white transition">
            ...
            <div className="hidden md:flex justify-center">
              <div className="relative">
                ...
                <div className="relative bg-gradient-to-br from-[#1a1a2e] to-[#0a0a0a] border border-white/10 rounded-3xl p-8 shadow-2xl">
                  <div className="w-40 h-40 mx-auto mb-6 bg-gradient-to-br from-violet-500 via-cyan-500 to-pink-500 rounded-full flex items-center justify-center">
        ...
        <div className="max-w-6xl mx-auto px-8">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {technologies.map((tech, i) => (
              <span key={i} className="px-5 py-2.5 bg-white/5 border border-white/10 rounded-full text-sm text-gray-300 hover:border-violet-500/50 hover:text-white transition cursor-default">
                {tech}
              </span>
            ))}
          </div>
        ...
        <div className="max-w-6xl mx-auto px-8 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {services.map((service, i) => (
              <div key={i} className="group p-8 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 hover:border-violet-500/30 transition duration-300">
      ...
      {/* PROJECTS */}
      <section id="proyectos" className="py-24 bg-white/5">
        <div className="max-w-6xl mx-auto px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {projects.map((project, i) => (
              <a 
                ...
                className="group block bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:bg-white/10 hover:border-cyan-500/30 transition duration-300"
              >
      ...
      <section id="contacto" className="py-24 relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-8 text-center relative z-10">
          ...
          <p className="text-xl text-gray-400 mb-10">
            Contáctame y hagamos tu proyecto realidad
          </p>
          <a 
            href="mailto:edu@local.dev"
            className="inline-flex items-center gap-3 bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 text-white px-10 py-4 rounded-full font-semibold text-lg transition transform hover:scale-105"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
            Enviar Email
          </a>
      ...
      <a 
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 w-14 h-14 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-400 hover:to-emerald-400 rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-all z-50"
      >
